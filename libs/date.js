...
Date.prototype.incrementDateByWorkingDays=function (days, isFullWeek) {
 console.debug("incrementDateByWorkingDays start ",days, " date ", this.getDate(), "/", this.getMonth(), " is fullWeek ", isFullWeek  )
  var q = Math.abs(days);
  while (q > 0) {
...
Date.prototype.distanceInWorkingDays= function (toDate, isFullWeek){
 console.debug("distanceInWorkingDays", " is fullWeek ", isFullWeek  )
